...
function DocumentConversion(options, comments) {
    ...
    function convertMath(element, messages, options) {
        ...
        var value = officeXmlReader.simplifyClarkNotation(element.value);
        // console.debug('Converting MathML:', value);
        var doc = xmldom.parseFromString(
            ['<w:document xmlns:m="http://schemas.openxmlformats.org/officeDocument/2006/math" xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main">', value, "</w:document>"].join(''),
            "text/xml",
        );
